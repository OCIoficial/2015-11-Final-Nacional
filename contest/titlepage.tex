...
\begin{titlingpage}
  ...
  \large{\thephase}
  \vskip 20pt
  \normalsize{\it Jornadas Chilenas de Computaci\'on \\ Escuela de Ingenier\'ia en Computaci\'on e Inform\'atica \\ Universidad Mayor \\ Santiago, 12 de Noviembre, \the\year}
...
\item {\bf El formato de salida debe ser seguido de manera estricta} considerando los espacios especificados.
