...
\begin{center}
\vskip -1em
	\includegraphics[scale=0.3]{gollum.jpg}
\end{center}
\vskip -1.5em
...
%Luego de reflexionar por un momento, y de emitir sonidos de naturaleza diversa, 
%Gollum llega a varias conclusiones sobre la secuencia.
...
\begin{scoreDescription}
  ...
  \score{35} Se probarán varios casos donde $10^{5} < n \leq 10^{10}$.
