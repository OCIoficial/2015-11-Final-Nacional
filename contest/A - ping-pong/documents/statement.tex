...
%  10 puntos: P = 1, A = B = 0 / respuesta = 2
%2) 10 puntos: P = 1, A = B = 1 / respuesta = 2 si N es múltiplo de 2, 1 si no lo es
%3) 20 puntos: A = B / respuesta = el que no parte si N es múltiplo de A+1, 1 si no lo es


\begin{scoreDescription}
  \score{10} Se probarán varios casos donde $1 \le N \le 100$, $P=1$, y $A=B=0$.
  \score{10} Se probarán varios casos donde $1 \le N \le 100$, $P=1$, y $A=B=1$.
  \score{20} Se probarán varios casos donde $1 \le N \le 100$, y $A=B$, $0\le A,B \le N$.
  \score{60} Se probarán varios casos donde $1 \le N \le 100$, y $1 \le A, B \le N$.
